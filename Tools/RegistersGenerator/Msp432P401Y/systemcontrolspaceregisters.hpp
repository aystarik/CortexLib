 ...
 *
 * Details       : System Control Space for ARM core: SCnSCB, SCB, SysTick,
 *NVIC, CoreDebug, MPU, FPU. This header file is auto-generated for MSP432P401Y
 *device.
 *
 *
 *******************************************************************************/
...
struct SystemControlSpace {
  ...
  struct MVFR0 : public RegisterBase<0xE000EF40, 32, ReadMode> {
    ...
    using FP_EXCEPTION_TRAPPING =
        SystemControlSpace_MVFR0_FP_EXCEPTION_TRAPPING_Values<SystemControlSpace::MVFR0, 12, 4, ReadMode, SystemControlSpaceMVFR0Base>;
  ...
  struct PFR1 : public RegisterBase<0xE000ED44, 32, ReadMode> {
    using MICROCONTROLLER_PROGRAMMERS_MODEL =
        SystemControlSpace_PFR1_MICROCONTROLLER_PROGRAMMERS_MODEL_Values<SystemControlSpace::PFR1, 8, 4, ReadMode, SystemControlSpacePFR1Base>;
  ...
  struct DFR0 : public RegisterBase<0xE000ED48, 32, ReadMode> {
    using MICROCONTROLLER_DEBUG_MODEL =
        SystemControlSpace_DFR0_MICROCONTROLLER_DEBUG_MODEL_Values<SystemControlSpace::DFR0, 20, 4, ReadMode, SystemControlSpaceDFR0Base>;
  ...
  struct MMFR0 : public RegisterBase<0xE000ED50, 32, ReadMode> {
    ...
    using CACHE_COHERENCE_SUPPORT =
        SystemControlSpace_MMFR0_CACHE_COHERENCE_SUPPORT_Values<SystemControlSpace::MMFR0, 8, 4, ReadMode, SystemControlSpaceMMFR0Base>;
    using OUTER_NON_SHARABLE_SUPPORT =
        SystemControlSpace_MMFR0_OUTER_NON_SHARABLE_SUPPORT_Values<SystemControlSpace::MMFR0, 12, 4, ReadMode, SystemControlSpaceMMFR0Base>;
    using AUXILIARY_REGISTER_SUPPORT =
        SystemControlSpace_MMFR0_AUXILIARY_REGISTER_SUPPORT_Values<SystemControlSpace::MMFR0, 20, 4, ReadMode, SystemControlSpaceMMFR0Base>;
  ...
  struct MMFR2 : public RegisterBase<0xE000ED58, 32, ReadMode> {
    using WAIT_FOR_INTERRUPT_STALLING =
        SystemControlSpace_MMFR2_WAIT_FOR_INTERRUPT_STALLING_Values<SystemControlSpace::MMFR2, 24, 4, ReadMode, SystemControlSpaceMMFR2Base>;
