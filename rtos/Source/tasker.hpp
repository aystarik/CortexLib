...
class Tasker {
 ...
 private:
  ...
  static constexpr size_t GetFirstActiveTaskId() { return GetFirstActiveTask<tasks...>(0U); }
  ...
  static void CallTask(size_t id) { return CallTaskById<tasks...>(id, 0U); }
  ...
  enum class Status : std::uint8_t { NotRunning, Running };
