...
struct Adc {
  static void SwitchOn() { ADC::CR2::ADON::Enable::Set(); }

  static void SwitchOff() { ADC::CR2::ADON::Disable::Set(); }

  static void StartConversion() { ADC::CR2::SWSTART::On::Set(); }

  static bool IsReady() { return ADC::SR::EOC::ConversionComplete::IsSet(); }

  static auto GetData() { return ADC::DR::Get(); }
