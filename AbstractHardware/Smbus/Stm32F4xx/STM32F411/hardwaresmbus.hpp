...
struct HardwareSmBusBase {
  void Init() {
    SmBusModule::CR1Pack<SmBusModule::CR1::SMBUS::SmBusMode, SmBusModule::CR1::SMBTYPE::Host SmBusModule::CR1::ACK::Acknowledge>::Set();

    SmBusModule::OAR1::ADD7::Set(0x01U);
    SmBusModule::OAR1::ADDMODE::Bits7::Set();
    SmBusModule::CCRPack<SmBusModule::CCR::DUTY::DutyCycles_2, SmBusModule::CCR::F_S::FastMode>::Set();
  }

  std::uint16_t ReadWord() { while }
};
