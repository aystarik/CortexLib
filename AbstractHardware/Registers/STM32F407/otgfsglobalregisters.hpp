...
struct OTG_FS_GLOBAL {
  ...
  struct FS_GNPTXFSIZ_Device : public RegisterBase<0x50000028, 32, ReadWriteMode> {
    using TX0FSA =
        OTG_FS_GLOBAL_FS_GNPTXFSIZ_Device_TX0FSA_Values<OTG_FS_GLOBAL::FS_GNPTXFSIZ_Device, 0, 16, ReadWriteMode, OTG_FS_GLOBALFS_GNPTXFSIZ_DeviceBase>;
    using TX0FD =
        OTG_FS_GLOBAL_FS_GNPTXFSIZ_Device_TX0FD_Values<OTG_FS_GLOBAL::FS_GNPTXFSIZ_Device, 16, 16, ReadWriteMode, OTG_FS_GLOBALFS_GNPTXFSIZ_DeviceBase>;
