...
struct DBGMCU {
  ...
  struct APB1_FZ : public RegisterBase<0x40015808, 32, ReadWriteMode> {
    ...
    using TIM3_counter_stopped_when_core_is_halted =
        DBGMCU_APB1_FZ_TIM3_counter_stopped_when_core_is_halted_Values<DBGMCU::APB1_FZ, 4, 1, ReadWriteMode, DBGMCUAPB1_FZBase>;
